...
FROM "Credenza"
JOIN "Evento"
	ON "Evento"."Codice" = "Credenza"."Evento"
JOIN "Intervallo"
	ON "Intervallo"."IstanteInizio" = "Credenza"."IstanteInizio" AND "Intervallo"."IstanteFine" = "Credenza"."IstanteFine"
WHERE "Credenza"."Agente" = 0 AND "Evento"."Veridicita" = FALSE