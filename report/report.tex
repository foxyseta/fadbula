...
nel riportare gli identificativi in SQL. Pur essendo questi supportati, questa è
...
italiana, in accordo con la lingua usata per l'insegnamento in oggetto.
...
Le seguenti tabella illustrazo i risultati restituiti dalle operazioni di
interrogazione.
